...
struct bmc_raptor_best_label {

  static bool dominates_non_destination(bmc_raptor_best_label const& l1, bmc_raptor_best_label const& l2);
  static bool dominates_destination(bmc_raptor_best_label const& l1, bmc_raptor_best_label const& l2);
  static bool equals(bmc_raptor_best_label const& l1, bmc_raptor_best_label const& l2);
